...
function layout(element) {
    ...
    if(mainSpace < 0) {
        // overflow (happends only if container is single line), scale ervery item
        ...
        flexLines.forEach(function (items) {
            ...
            if(flexTotal > 0) {
                ...
                // There is *NO* flexible flex items, which means, justifyContebt should work
    ...
    flexLines.forEach(function (item){
        ...
        crossBase += crossSign * (lineSize + step)
    })
    console.log(items)
}
